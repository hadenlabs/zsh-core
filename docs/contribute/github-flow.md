<!-- Space: Projects -->
<!-- Parent: ZshCore -->
<!-- Title: Contributing GithubFlow ZshCore -->
<!-- Label: ZshCore -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-core project on [GitHub](https://github.com/hadenlabs/zsh-core), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-core/pulls).
...
To follow the instructions in this guide and start contributing to zsh-core project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-core.git
```

Now your **upstream** points to **hadenlabs/zsh-core**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-core
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-core/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
